...
subtitle: "> Curso breve de técnicas modernas de análisis <br><i class='fas fa-link'></i> [Material](github.com/haro_ca/teaching/herramientas_de_analisis) <br> <i class='fa fa-twitter'></i> [Twitter](https://twitter.com/haro_ca_)"
...
output:
  xaringan::moon_reader:
    self_contained: TRUE
    lib_dir: libs
    css: ["xaringan_themer.css", "slides_style.css"]
    nature:
...
.pull-right[
PDF en [éste](https://github.com/haro-ca/teaching/raw/master/herramientas_de_analisis/temario/temario.pdf) link
]
---
# Temario
...
.center[
```{r}
countdown::countdown(minutes = 2L)
```
