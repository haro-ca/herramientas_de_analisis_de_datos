...
```{r Logo}
knitr::include_graphics(here::here('ch.png'))
...
El curso no será suficiente para dar un conocimiento profundo, aunque sí tiene la intención 
de desarrollar un lenguaje mínimo para comenzar a practicar, indagar, y profundizar en el trabajo con 
datos.  
